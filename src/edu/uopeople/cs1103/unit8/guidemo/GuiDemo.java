...
public class GuiDemo extends JFrame{
	...
	public GuiDemo() {
		...
		content.add(createBackgroundToolbar(), BorderLayout.NORTH);
		...
		menuBar.add(iconSupport.createMenu()); // add new menu item
		setJMenuBar(menuBar);
	...
	/**
	 *
	 * @return JToolBar with backgrounds and file items
	 * @author Mark Bensch
	 */
	private JToolBar createBackgroundToolbar(){
	 ...
	 * EDIT:
	 * @author Mark Bensch
	 * added icons to custom and color
     */
